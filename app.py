...
app = Flask(__name__)
# Secret key in order to make it un-editable by user.
app.secret_key = 'your secret key'
# Location, host and password of your database
Database.initialise(host='localhost', database='Learning', user='postgres', password='your password')
...
# debug=True is to get more information in case needed.